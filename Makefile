# This Makefile is for the twitterClone extension to perl.
#
...
#     AUTHOR => [q[Eric Fleming Lin,,,]]
#     BUILD_REQUIRES => { Test::More=>q[0.88], ExtUtils::MakeMaker=>q[6.36] }
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[twitterClone]
#     EXE_FILES => [q[script/twitterclone_cgi.pl], q[script/twitterclone_create.pl], q[script/twitterclone_fastcgi.pl], q[script/twitterclone_server.pl], q[script/twitterclone_test.pl]]
#     LICENSE => q[perl]
#     NAME => q[twitterClone]
#     NO_META => q[1]
...
PERL = /usr/bin/perl5.16.3 "-Iinc"
FULLPERL = /usr/bin/perl5.16.3 "-Iinc"
ABSPERL = $(PERL)
PERLRUN = $(PERL)
...
MAKE = make
FULLEXT = twitterClone
BASEEXT = twitterClone
PARENT_NAME = 
DLBASE = $(BASEEXT)
VERSION_FROM = lib/twitterClone.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
O_FILES  = 
H_FILES  = 
MAN1PODS = script/twitterclone_cgi.pl \
	script/twitterclone_create.pl \
	script/twitterclone_fastcgi.pl \
...
DISTNAME = twitterClone
DISTVNAME = twitterClone-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=1 --perm_rw=$(PERM_RW) \
	  ...
	  script/twitterclone_test.pl $(INST_MAN1DIR)/twitterclone_test.pl.$(MAN1EXT) \
	  script/twitterclone_cgi.pl $(INST_MAN1DIR)/twitterclone_cgi.pl.$(MAN1EXT) \
...
EXE_FILES = script/twitterclone_cgi.pl script/twitterclone_create.pl script/twitterclone_fastcgi.pl script/twitterclone_server.pl script/twitterclone_test.pl

pure_all :: $(INST_SCRIPT)/twitterclone_server.pl $(INST_SCRIPT)/twitterclone_fastcgi.pl $(INST_SCRIPT)/twitterclone_test.pl $(INST_SCRIPT)/twitterclone_cgi.pl $(INST_SCRIPT)/twitterclone_create.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/twitterclone_server.pl $(INST_SCRIPT)/twitterclone_fastcgi.pl \
	  $(INST_SCRIPT)/twitterclone_test.pl $(INST_SCRIPT)/twitterclone_cgi.pl \
	  $(INST_SCRIPT)/twitterclone_create.pl 

$(INST_SCRIPT)/twitterclone_server.pl : script/twitterclone_server.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/twitterclone_server.pl
	$(CP) script/twitterclone_server.pl $(INST_SCRIPT)/twitterclone_server.pl
	$(FIXIN) $(INST_SCRIPT)/twitterclone_server.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/twitterclone_server.pl

$(INST_SCRIPT)/twitterclone_fastcgi.pl : script/twitterclone_fastcgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/twitterclone_fastcgi.pl
	$(CP) script/twitterclone_fastcgi.pl $(INST_SCRIPT)/twitterclone_fastcgi.pl
	$(FIXIN) $(INST_SCRIPT)/twitterclone_fastcgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/twitterclone_fastcgi.pl

$(INST_SCRIPT)/twitterclone_test.pl : script/twitterclone_test.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/twitterclone_test.pl
	$(CP) script/twitterclone_test.pl $(INST_SCRIPT)/twitterclone_test.pl
	$(FIXIN) $(INST_SCRIPT)/twitterclone_test.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/twitterclone_test.pl

$(INST_SCRIPT)/twitterclone_cgi.pl : script/twitterclone_cgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/twitterclone_cgi.pl
	$(CP) script/twitterclone_cgi.pl $(INST_SCRIPT)/twitterclone_cgi.pl
	$(FIXIN) $(INST_SCRIPT)/twitterclone_cgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/twitterclone_cgi.pl

$(INST_SCRIPT)/twitterclone_create.pl : script/twitterclone_create.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/twitterclone_create.pl
	$(CP) script/twitterclone_create.pl $(INST_SCRIPT)/twitterclone_create.pl
	$(FIXIN) $(INST_SCRIPT)/twitterclone_create.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/twitterclone_create.pl
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Eric Fleming Lin,,,</AUTHOR>' >> $(DISTNAME).ppd
